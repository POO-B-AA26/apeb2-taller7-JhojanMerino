 ...
 */
abstract class Problema3_Mensaje {
    ...
    public Problema3_Mensaje(String remitenteNumero, String remitenteNombre, String destinatarioNumero,
            String destinatarioNombre) {
        this.remitenteNumero = remitenteNumero;
        this.remitenteNombre = (remitenteNombre == null || remitenteNombre.trim().isEmpty()) ? "Sin Nombre"
                : remitenteNombre;
        this.destinatarioNumero = destinatarioNumero;
        this.destinatarioNombre = (destinatarioNombre == null || destinatarioNombre.trim().isEmpty()) ? "Sin Nombre"
                : destinatarioNombre;
    }
    ...
    public String toString() {
        return String.format("Remitente: %s (%s) -> Destinatario: %s (%s)",
                remitenteNumero, remitenteNombre, destinatarioNumero, destinatarioNombre);
    }
}

class SMS extends Problema3_Mensaje {
    private String mensajeText;

    public SMS(String remitenteNumero, String remitenteNombre, String destinatarioNumero, String destinatarioNombre,
            String mensajeText) {
        super(remitenteNumero, remitenteNombre, destinatarioNumero, destinatarioNombre);
        this.mensajeText = mensajeText;
    }

    @Override
    public String enviarMensaje() {
        return "SMS: Mensaje enviado con éxito de " + remitenteNumero + " a " + destinatarioNumero + ".";
    }

    @Override
    public String visualizarMensaje() {
        return String.format("--- Mensaje de Texto (SMS) ---\n%s\nContenido: %s\n-----------------------------",
                super.toString(), mensajeText);
    }

    @Override
    public String toString() {
        return super.toString() + " | Tipo: SMS | Mensaje: \"" + mensajeText + "\"";
    }
}

class MMS extends Problema3_Mensaje {
    private String nombreFichero;

    public MMS(String remitenteNumero, String remitenteNombre, String destinatarioNumero, String destinatarioNombre,
    ...
    @Override
    public String enviarMensaje() {
        return "MMS: Mensaje multimedia enviado con éxito de " + remitenteNumero + " a " + destinatarioNumero + ".";
    }
    ...
    public String visualizarMensaje() {
        return String.format(
                ...
                super.toString(), nombreFichero);
    }

    @Override
    public String toString() {
        return super.toString() + " | Tipo: MMS | Fichero: \"" + nombreFichero + "\"";
    }
}

public class Mensajes {
    public static void main(String[] args) {
        SMS sms = new SMS("0987654321", "Jhojan Merino", "0991234567", "Ana Lopez", "Hola Ana, ya terminé el taller.");
        MMS mms = new MMS("0987654321", "Jhojan Merino", "0998887777", null, "Mensajes");
...
--- Mensaje Multimedia (MMS) ---
Remitente: 0987654321 (Jhojan Merino) -> Destinatario: 0998887777 (Sin Nombre)
Fichero Imagen: Mensajes.png
---------------------------------
PS C:\Users\USER\OneDrive\Documentos\GitHub\apeb2-taller7-JhojanMerino\Solucion_Codigo> */